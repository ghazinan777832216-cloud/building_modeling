...
new_source = [
    ...
    "<div id='viewer-v18' style='position: relative; width:100%; height:600px; background: linear-gradient(#202020, #444); border-radius:10px; overflow: hidden;'></div>\n",
    "<div id='log-v18' style='color:#0f0; background:#000; padding:5px; font-family:monospace; font-size:11px;'>Initializing High-Quality Mode...</div>\n",
    "\n",
    ...
    "<script>\n",
    "(function() {{\n",
    "    const log = (m) => document.getElementById('log-v18').innerText = '> ' + m;\n",
    "    \n",
    ...
    "            const viewerDiv = document.getElementById('viewer-v18');\n",
